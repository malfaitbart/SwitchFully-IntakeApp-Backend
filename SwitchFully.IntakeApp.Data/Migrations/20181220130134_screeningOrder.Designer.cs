...
namespace SwitchFully.IntakeApp.Data.Migrations
{
    ...
    [Migration("20181220130134_screeningOrder")]
    partial class screeningOrder
    {
            ...
            modelBuilder.Entity("SwitchFully.IntakeApp.Domain.Campaigns.Campaign", b =>
                {
                    ...
                    b.HasData(
                        new { CampaignId = new Guid("134463e4-d964-45aa-b6e9-d61419e865e2"), Client = "CM", EndDate = new DateTime(2019, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "asp.net", StartDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { CampaignId = new Guid("c1853eab-343d-4c44-b249-3de07f87bf94"), Client = "Cegeka", EndDate = new DateTime(2019, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "java", StartDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { CampaignId = new Guid("5bca94c3-0819-4ce7-b2fa-f2be661f6c66"), Client = "OZ", EndDate = new DateTime(2019, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "asp.net", StartDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                    );
                });
