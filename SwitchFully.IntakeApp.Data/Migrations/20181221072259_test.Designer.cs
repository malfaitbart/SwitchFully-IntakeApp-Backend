            ...
            modelBuilder.Entity("SwitchFully.IntakeApp.Domain.Campaigns.Campaign", b =>
                {
                    ...
                    b.HasData(
                        new { CampaignId = new Guid("70d9473d-8000-4f5c-bde1-e3c1761ce7b8"), Client = "CM", EndDate = new DateTime(2019, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "asp.net", StartDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { CampaignId = new Guid("db042ca0-3ab4-4d9b-a582-1d6e8183ba20"), Client = "Cegeka", EndDate = new DateTime(2019, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "java", StartDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { CampaignId = new Guid("3d621cc0-958d-44c4-b7d9-5bd0b3577cb2"), Client = "OZ", EndDate = new DateTime(2019, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "asp.net", StartDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                    );
                });
            ...
            modelBuilder.Entity("SwitchFully.IntakeApp.Domain.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("3d75d7b5-532e-474d-a3eb-d1d3f2e9cf73"), FirstName = "test", LastName = "user", RoleId = 1 }
                    );
                });
                    ...
                    b.OwnsOne("SwitchFully.IntakeApp.Domain.Users.UserSecurity", "SecurePassword", b1 =>
                        {
                            ...
                            b1.HasData(
                                new { UserId = new Guid("3d75d7b5-532e-474d-a3eb-d1d3f2e9cf73"), Salt = "nhSRFAcAR6lgnY40PZi4iw==" }
                            );
                        });
                    ...
                    b.OwnsOne("System.Net.Mail.MailAddress", "Email", b1 =>
                        {
                            ...
                            b1.HasData(
                                new { UserId = new Guid("3d75d7b5-532e-474d-a3eb-d1d3f2e9cf73"), Address = "test@user.be" }
                            );
                        });
                });
